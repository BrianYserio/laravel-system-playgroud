...
<div class="flex flex-col justify-center sm:h-screen p-4">
      <div class="max-w-md w-full mx-auto border border-gray-300 rounded-2xl p-8">
        ...
        @csrf
          <div class="space-y-6">
             <div>
              <label class="text-slate-900 text-sm font-medium mb-2 block">Fullname</label>
              <input name="name" type="text" class="text-slate-900 bg-white border border-gray-300 w-full text-sm px-4 py-3 rounded-md outline-blue-500" placeholder="Enter your name" />
            </div>
            <div>
              <label class="text-slate-900 text-sm font-medium mb-2 block">Email Id</label>
              <input name="email" type="text" class="text-slate-900 bg-white border border-gray-300 w-full text-sm px-4 py-3 rounded-md outline-blue-500" placeholder="Enter your email" />
            </div>
            <div>
          ...
          <p class="text-slate-600 text-sm mt-6 text-center">Already have an account? <a href="#" class="text-blue-600 font-medium hover:underline ml-1">Login here</a></p>
        </form>
      </div>
    </div>
